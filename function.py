...
path = 'tuned_model/tokenizer.pkl'
...
url = 'https://drive.google.com/uc?id=1vJquOfNmpJVhWG8jPO-LOO5znWI9Qjhq'
...
def get_table_download_link(df):
    ...
    href = custom_css + f'<a href="data:file/csv;base64,{b64}" download="tweets.csv" id="{button_id}">CLICK HERE TO DOWNLOAD CSV FILE</a></br></br>'
    return href
...
def twitter_get(select_hashtag_keyword, user_word_entry, num_of_tweets):  
    ...
    api = tw.API(auth, wait_on_rate_limit = True, wait_on_rate_limit_notify=True, sleep_on_rate_limit=False)
    ...
    df_new = df_new.rename(columns = {"user": "Username",
                                  "full_text": "Tweet"})
